...
const DEFAULT_IMAGES: ImageItem[] = [
  { src: '/placements/placement_1.jpg', alt: 'Placed student' },
  { src: '/placements/placement_2.jpg', alt: 'Placed student' },
  { src: '/placements/placement_3.jpg', alt: 'Placed student' },
  { src: '/placements/placement_4.jpg', alt: 'Placed student' },
  { src: '/placements/placement_5.jpg', alt: 'Placed student' },
];
...
const DEFAULTS = {
  ...
  segments: 20 // Reduced for better performance
};
...
interface ItemWithImage extends Coord {
  src: string;
  alt: string;
}
