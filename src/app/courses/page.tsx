            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
              {courses?.map((course) => {
                ...
                return (
                  <div
                    key={course.id}
                    className="relative rounded-3xl border border-gray-200 bg-white shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden"
                  >
                    {/* Featured Badge */}
                    {course.is_featured && (
                    ...
                    <div className="p-6 flex items-center justify-between">
                      ...
                      <Link
                        ...
                        className={`inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r ${theme.gradient} text-white font-bold rounded-xl shadow-lg hover:shadow-md hover:scale-[0.98] transition-all`}
                      >
                        View Details
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  <div
                    key={i}
                    className="p-6 bg-white rounded-2xl border border-gray-200 shadow-lg text-center"
                  >
