...
export default function ContactPage() {
  ...
  const inputClass = (field: string) =>
    `w-full px-5 py-4 border-2 rounded-2xl text-sm font-bold transition-all outline-none bg-white ${
      focused === field
        ...
        <div className="container-wide relative z-10" ref={heroRef}>
          <div className="flex flex-col lg:flex-row items-end justify-between gap-10">
            <div className="max-w-3xl">
              <div className="hero-animate inline-flex items-center gap-3 bg-white text-primary font-black text-xs uppercase tracking-widest px-4 py-2 mb-6 rounded-full shadow-[4px_4px_0px_rgba(0,0,0,1)] border-2 border-primary-dark">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {contactInfo.map((info, i) => (
              <AnimatedSection key={info.label} delay={i * 0.08}>
                <a
                  href={info.href}
                  className="group flex flex-col gap-4 p-6 rounded-2xl border-2 border-white/10 bg-white/5 hover:bg-white/10 hover:border-white/30 transition-all duration-300 backdrop-blur-sm shadow-[4px_4px_0px_rgba(0,0,0,0.3)] hover:-translate-y-1 hover:shadow-[8px_8px_0px_rgba(0,0,0,0.5)]"
                >
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center bg-white/10 border border-white/20 group-hover:bg-[#82C93D] group-hover:border-[#82C93D] transition-colors">
                  ...
                  <div>
                    ...
                    {'subValue' in info && info.subValue && (
                      <div className="text-xs font-bold text-white/50 mt-0.5">{info.subValue}</div>
                    )}
                  </div>
                </a>
              </AnimatedSection>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-2">
              <AnimatedSection direction="left">
                <div className="mb-12">
                  <div className="inline-block bg-primary text-white font-black text-xs uppercase tracking-widest px-4 py-2 mb-6 rounded-full shadow-[4px_4px_0px_rgba(0,0,0,1)] border-2 border-primary-dark">
                    Why Choose Us
                  </div>
                  <div className="space-y-5">
                    {[
                      ...
                      <div key={i} className="flex items-start gap-3 group">
                        <div className="w-6 h-6 rounded-lg bg-primary-dark border-2 border-primary-dark flex items-center justify-center shrink-0 mt-0.5 shadow-[2px_2px_0px_rgba(130,201,61,0.5)]">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {faqItems.map((faq, i) => (
                      <div key={i} className="border-2 border-primary-dark p-5 rounded-2xl shadow-[4px_4px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5 hover:shadow-[6px_6px_0px_rgba(0,0,0,1)] transition-all">
            ...
            <div className="lg:col-span-3">
              <AnimatedSection direction="right" delay={0.15}>
                <div className="border-2 border-primary-dark rounded-3xl shadow-[12px_12px_0px_rgba(0,0,0,1)] overflow-hidden">
                  {/* Form header */}
                  <div className="bg-primary-dark text-white px-8 py-6 border-b-2 border-primary-dark">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="w-12 h-12 rounded-xl bg-[#82C93D]/20 border border-[#82C93D]/40 flex items-center justify-center">
                  ...
                  <div className="p-8 md:p-10">
                    {submitted ? (
                      <div className="text-center py-16">
                        <div className="w-20 h-20 rounded-2xl mx-auto flex items-center justify-center bg-primary-dark border-2 border-primary-dark mb-6 shadow-[6px_6px_0px_rgba(130,201,61,1)]">
                        ...
                        <button
                          ...
                          className="mt-8 bg-primary-dark text-white font-black text-xs uppercase tracking-widest px-8 py-4 border-2 border-primary-dark rounded-full shadow-[4px_4px_0px_rgba(0,0,0,1)] hover:-translate-y-1 hover:shadow-[6px_6px_0px_rgba(0,0,0,1)] transition-all"
                        >
      ...
      <section className="relative w-full h-[300px] md:h-[380px] overflow-hidden border-b-2 border-black/10">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white">
            <div className="inline-block bg-white text-primary-dark font-black text-xs uppercase tracking-widest px-4 py-2 mb-6 rounded-full shadow-[4px_4px_0px_rgba(255,255,255,0.3)] border-2 border-white/50">
              Our Office
            </div>
            <h3 className="text-3xl md:text-4xl font-heading font-black mb-4">Visit Us in Person</h3>
            <p className="text-white/60 font-bold">Rajahmundry · Open Mon–Sat</p>
          </div>
        </div>
      </section>
