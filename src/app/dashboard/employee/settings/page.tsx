...
export default function EmployeeSettingsPage() {
  return (
    <div>
      <PageHeader title="Settings" description="Manage your employee account" />
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <DashboardPanel title="Profile">
          <div className="space-y-4">
            ...
            <div><label className="block text-sm font-medium text-foreground/70 mb-1">Department</label><input type="text" className="w-full border border-border rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary-bright" /></div>
