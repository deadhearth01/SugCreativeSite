...
const events = [
  ...
  { date: 22, title: 'Workshop Prep', time: '10:00 AM', color: 'bg-primary-bright' },
  { date: 25, title: 'Team Standup', time: '9:30 AM', color: 'bg-mint' },
]
...
export default function EmployeeCalendarPage() {
  ...
  return (
    <div>
      <PageHeader title="Calendar" description="Your work schedule" />
