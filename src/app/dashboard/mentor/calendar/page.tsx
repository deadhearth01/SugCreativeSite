...
const events = [
  { date: 18, title: 'Career Counseling — Arjun', time: '2:00 PM', color: 'bg-primary-bright' },
  { date: 22, title: 'Mock Interview — Sneha', time: '11:00 AM', color: 'bg-primary' },
  { date: 25, title: 'Progress Review — Karan', time: '3:00 PM', color: 'bg-mint' },
]
...
export default function MentorCalendarPage() {
  ...
  return (
    <div>
      <PageHeader title="Calendar" description="Your mentoring schedule" />
