...
export default function ClientSettingsPage() {
  return (
    <div>
      <PageHeader title="Settings" description="Manage your client account" />
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <DashboardPanel title="Company Information">
          <div className="space-y-4">
            <div><label className="block text-sm font-medium text-foreground/70 mb-1">Company Name</label><input type="text" className="w-full border border-border rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary-bright" /></div>
            <div><label className="block text-sm font-medium text-foreground/70 mb-1">Contact Person</label><input type="text" className="w-full border border-border rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-primary-bright" /></div>
