...
const tickets = [
  { id: '#C-101', subject: 'Invoice discrepancy', status: 'Open', created: 'Jun 14, 2025' },
  { id: '#C-098', subject: 'Need project timeline update', status: 'Resolved', created: 'Jun 08, 2025' },
]

export default function ClientTicketsPage() {
  return (
    <div>
      <PageHeader title="Support & Tickets" description="Get help with your projects or billing" action={
