        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          {activeSection === 'experience' && (
            <DashboardPanel
              title="Experience"
              action={
                <button onClick={addExperience} className="text-xs text-primary-bright font-semibold flex items-center gap-1 hover:underline">
                  ...
                  {resume.experience.map((exp, i) => (
                    <div key={i} className="border border-border/50 rounded-lg p-4 space-y-3">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <input type="text" placeholder="Job Title" value={exp.title} onChange={(e) => updateExperience(i, 'title', e.target.value)} className="border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary-bright" />
                        <input type="text" placeholder="Company Name" value={exp.company} onChange={(e) => updateExperience(i, 'company', e.target.value)} className="border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary-bright" />
                        <input type="text" placeholder="Start Date (e.g. Jan 2023)" value={exp.start_date} onChange={(e) => updateExperience(i, 'start_date', e.target.value)} className="border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary-bright" />
                        <input type="text" placeholder="End Date (or Present)" value={exp.end_date} onChange={(e) => updateExperience(i, 'end_date', e.target.value)} className="border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary-bright" />
                      </div>
                      <textarea rows={2} placeholder="Describe your responsibilities..." value={exp.description} onChange={(e) => updateExperience(i, 'description', e.target.value)} className="w-full border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary-bright resize-none" />
                    </div>
                  ))}
                </div>
              )}
          ...
          {activeSection === 'education' && (
            <DashboardPanel
              title="Education"
              action={
                <button onClick={addEducation} className="text-xs text-primary-bright font-semibold flex items-center gap-1 hover:underline">
                ...
                <div className="space-y-4">
                  {resume.education.map((edu, i) => (
                    <div key={i} className="border border-border/50 rounded-lg p-4 space-y-3">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <input type="text" placeholder="Degree" value={edu.degree} onChange={(e) => updateEducation(i, 'degree', e.target.value)} className="border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary-bright" />
                        <input type="text" placeholder="Institution" value={edu.institution} onChange={(e) => updateEducation(i, 'institution', e.target.value)} className="border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary-bright" />
                        <input type="text" placeholder="Year (e.g. 2020–2024)" value={edu.year} onChange={(e) => updateEducation(i, 'year', e.target.value)} className="border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary-bright" />
                        <input type="text" placeholder="Grade / CGPA" value={edu.grade} onChange={(e) => updateEducation(i, 'grade', e.target.value)} className="border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary-bright" />
                      </div>
                    </div>
                  ))}
                </div>
          ...
          {activeSection === 'projects' && (
            <DashboardPanel
              title="Projects"
              action={
                <button onClick={addProject} className="text-xs text-primary-bright font-semibold flex items-center gap-1 hover:underline">
                ...
                <div className="space-y-4">
                  {resume.projects.map((proj, i) => (
                    <div key={i} className="border border-border/50 rounded-lg p-4 space-y-3">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <input type="text" placeholder="Project Name" value={proj.name} onChange={(e) => updateProject(i, 'name', e.target.value)} className="border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary-bright" />
                        <input type="url" placeholder="Project URL" value={proj.url} onChange={(e) => updateProject(i, 'url', e.target.value)} className="border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary-bright" />
                      </div>
                      <textarea rows={2} placeholder="Describe the project..." value={proj.description} onChange={(e) => updateProject(i, 'description', e.target.value)} className="w-full border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary-bright resize-none" />
                    </div>
                  ))}
                </div>
              )}
          ...
          {activeSection === 'certifications' && (
            <DashboardPanel
              ...
              action={
                <button onClick={addCertification} className="text-xs text-primary-bright font-semibold flex items-center gap-1 hover:underline">
                  ...
                  {resume.certifications.map((cert, i) => (
                    <div key={i} className="border border-border/50 rounded-lg p-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        <input type="text" placeholder="Certification Name" value={cert.name} onChange={(e) => updateCertification(i, 'name', e.target.value)} className="border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary-bright" />
                        <input type="text" placeholder="Issuing Organization" value={cert.issuer} onChange={(e) => updateCertification(i, 'issuer', e.target.value)} className="border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary-bright" />
                        <input type="text" placeholder="Year" value={cert.year} onChange={(e) => updateCertification(i, 'year', e.target.value)} className="border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary-bright" />
                      </div>
                    </div>
                  ))}
                </div>
