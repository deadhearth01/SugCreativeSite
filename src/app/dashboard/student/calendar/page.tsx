...
const events = [
  { date: 18, title: 'Career Counseling', time: '2:00 PM', color: 'bg-primary-bright' },
  { date: 20, title: 'Resume Workshop', time: '11:00 AM', color: 'bg-primary' },
  { date: 22, title: 'Mock Interview', time: '11:00 AM', color: 'bg-mint' },
