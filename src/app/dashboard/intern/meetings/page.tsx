...
export default function InternMeetingsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Meetings" description="Your scheduled sessions and standups" />
      ...
      <DashboardPanel title={`Meetings (${filtered.length})`}>
        {filtered.length === 0 ? (
          <div className="py-12 text-center">
            ...
            <p className="text-sm text-foreground/40">No meetings scheduled yet</p>
            <p className="text-xs text-foreground/30 mt-1">Your mentor or admin will invite you to meetings</p>
          </div>
        ) : (
